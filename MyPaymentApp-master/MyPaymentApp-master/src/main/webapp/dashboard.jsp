    ...
    <div class="container dashboard-container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 card-custom">
                ...
                <p><strong>Account No:</strong> 9675</p>
                <p><strong>Balance:</strong> ₹2700.00</p>
                <p><strong>Wallet:</strong> ₹500.00 <a href="#" class="text-primary">[+]</a></p>
        ...
        <div class="row mt-4 card-custom">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item">₹1000 sent to chanakya</li>
                <li class="list-group-item">₹2500 received from ashit</li>
                <li class="list-group-item">₹1200 received from nex</li>
            </ul>
